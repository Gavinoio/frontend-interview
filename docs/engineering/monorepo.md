...
::: details 1. Monorepo 和 Multirepo 的优缺点？
**Monorepo 优点：**
- 代码共享简单，无需发包
- 原子提交，跨项目修改更容易
- 统一的依赖版本管理
...
::: details 2. pnpm workspace 和 yarn workspace 的区别？
- pnpm 使用硬链接，节省磁盘空间
...
::: details 4. 如何处理 Monorepo 中的版本管理？
