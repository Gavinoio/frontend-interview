...
::: details 1. Composition API 相比 Options API 有什么优势？
- **逻辑复用**：通过组合式函数更容易复用逻辑
...
::: details 5. Composition API 如何实现逻辑复用？
