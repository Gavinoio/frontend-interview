...
::: details 7. Hooks 的实现原理是什么？为什么不能在条件语句中使用？
...
::: details 8. useEffect 和 useLayoutEffect 的区别？
...
::: details 9. useMemo 和 useCallback 的区别？
```javascript
// useMemo：缓存计算结果（值）
...
::: details 10. useState 和 useReducer 如何选择？
...
::: details 12. Redux 和 Context 的区别？什么时候用哪个？
| 特性 | Context | Redux |
|------|---------|-------|
...
::: details 13. Redux Toolkit 相比原始 Redux 有什么优势？
...
::: details 14. Zustand vs Redux Toolkit 如何选择？
...
::: details 15. React Query 和 Redux 的区别？
...
::: details 16. React.memo、useMemo、useCallback 的区别？
```javascript
...
::: details 18. BrowserRouter 和 HashRouter 的区别？
...
::: details 21. useTransition 和 useDeferredValue 的区别？
...
::: details 23. App Router 和 Pages Router 的区别？
...
::: details 24. React Server Components（RSC）是什么？
