...
::: details 2. 什么时候用 Context，什么时候用状态管理库？
```
使用 Context:
- 低频更新的数据（主题、语言、用户信息）
- 组件树局部状态
...
::: details 3. Zustand vs Redux Toolkit？
```
选 Zustand:
- 追求简洁
- 小型项目
